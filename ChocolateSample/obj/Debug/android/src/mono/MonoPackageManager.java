...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ChocolateSample.dll" comes first in this list. */
		"ChocolateSample.dll",
		"chocolate_adcolony_adapter.dll",
		"chocolate_amazon_adapter.dll",
		"chocolate_applovin_adapter.dll",
		"chocolate_criteo_adapter.dll",
		"xam.android.chocolate_ads_admob_adapter.dll",
		"xam.android.chocolate_sdk_core.2.8.6.dll",
		"xam.android.chocolate_unityads_adapter.dll",
